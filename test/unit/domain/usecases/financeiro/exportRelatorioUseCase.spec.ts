...
import exportRelatorioUseCase from '../../../../../src/domain/usecases/financeiro/exportRelatorioUseCase';
...
describe('Domain :: UseCases :: Financeiro :: ExportRelatorio', () => {
  ...
  test('Export report', async (done) => {
    try {
      ...
      const exportUseCase = exportRelatorioUseCase();

      const excel = await exportUseCase(data);
