...
const exportRelatorioUseCase = () => async (dataRelatorio: any): Promise<string> => {
  ...
  const excel = generate(map(dataRelatorio));

  return excel;
};

export default exportRelatorioUseCase;
