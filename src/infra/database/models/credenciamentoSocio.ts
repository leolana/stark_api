...
const credenciamentoSocioModel = (sequelize: Sequelize, dataTypes: DataTypes) => {
  const credenciamentoSocio = sequelize.define(
    'credenciamentoSocio',
    {
      credenciamentoId: {
  ...
  return credenciamentoSocio;
};

export default credenciamentoSocioModel;
